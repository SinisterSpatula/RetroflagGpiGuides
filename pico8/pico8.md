...
[![Twitter](../images/Twitter.png)](https://twitter.com/MicroByter)
[![Instagram](../images/Instagram.png)](https://www.instagram.com/microbyter/)

----

## Recommended Software and tools:

* [Pico-8](https://www.lexaloffle.com/pico-8.php) Software

* FTP Transfer software to connect to the Raspberry Pi - [WinSCP](https://winscp.net/eng/download.php) for Windows, [Cyberduck](https://cyberduck.io/) for MacOS

* Terminal SSH software: [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) for Windows
